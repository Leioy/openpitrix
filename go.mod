module kubesphere.io/openpitrix

go 1.18

require (
	gopkg.in/inf.v0 v0.9.1 // indirect; indirectsigs.k8s.io/controller-runtime
	gopkg.in/ini.v1 v1.67.0 // indirect; sigs.k8s.io/controller-runtime
)
...
require (
	...
	kubesphere.io/utils v0.0.0-20221101055406-f7d14fe9cf23
