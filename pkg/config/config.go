...
import (
	...
	"kubesphere.io/openpitrix/pkg/client/openpitrix"
)
...
const (
	...
	defaultConfigurationName = "openpitrix"

	// DefaultConfigurationPath the default location of the configuration file
	defaultConfigurationPath = "/etc/openpitrix"
)
...
func GetFromConfigMap(cm *corev1.ConfigMap) (*Config, error) {
	...
	if !ok {
		return nil, fmt.Errorf("failed to get configmap openpitrix.yaml value")
	}
