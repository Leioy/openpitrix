...
func (r *ReconcileHelmRelease) GetChartData(rls *v1alpha12.HelmRelease) (chartName string, chartData []byte, err error) {
	if rls.Spec.RepoId != "" && rls.Spec.RepoId != v1alpha12.AppStoreRepoId {
