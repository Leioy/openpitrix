...
var _ = BeforeSuite(func(done Done) {
	...
	err = (&helmapplication2.ReconcileHelmApplication{}).SetupWithManager(k8sManager)
	Expect(err).ToNot(HaveOccurred())

	err = (&helmapplication2.ReconcileHelmApplicationVersion{}).SetupWithManager(k8sManager)
	Expect(err).ToNot(HaveOccurred())
