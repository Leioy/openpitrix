...
import (
	...
	openpitrixoptions "kubesphere.io/openpitrix/pkg/client/openpitrix"
	"kubesphere.io/openpitrix/pkg/client/s3"
	"kubesphere.io/openpitrix/pkg/constants"
	"kubesphere.io/openpitrix/pkg/informers"
	openpitrix2 "kubesphere.io/openpitrix/pkg/models/openpitrix"
...
type openpitrixHandler struct {
	openpitrix openpitrix2.Interface
}

func NewOpenpitrixClient(ksInformers informers.InformerFactory, ksClient versioned.Interface, option *openpitrixoptions.Options, cc clusterclient.ClusterClients, kubeConfig string, k8sClient kubernetes.Interface, stopCh <-chan struct{}) openpitrix2.Interface {
	...
	return openpitrix2.NewOpenpitrixOperator(ksInformers, ksClient, s3Client, cc, kubeConfig, k8sClient, stopCh)
}

func (h *openpitrixHandler) CreateRepo(req *restful.Request, resp *restful.Response) {

	createRepoRequest := &openpitrix2.CreateRepoRequest{}
	...
	*createRepoRequest.Workspace = req.PathParameter("workspace")
	...
	repo := v1alpha12.HelmRepo{
		ObjectMeta: metav1.ObjectMeta{
			Name: idutils.GetUuid36(v1alpha12.HelmRepoIdPrefix),
	...
	if syncPeriod > 0 {
		repo.Annotations[v1alpha12.RepoSyncPeriod] = createRepoRequest.SyncPeriod
	}
...
func (h *openpitrixHandler) DoRepoAction(req *restful.Request, resp *restful.Response) {
	repoActionRequest := &openpitrix2.RepoActionRequest{}
...
func (h *openpitrixHandler) ModifyRepo(req *restful.Request, resp *restful.Response) {
	var updateRepoRequest openpitrix2.ModifyRepoRequest
	repoId := req.PathParameter("repo")
...
func (h *openpitrixHandler) ListRepos(req *restful.Request, resp *restful.Response) {
	...
	orderBy := params.GetStringValueWithDefault(req, params.OrderByParam, openpitrix2.CreateTime)
	...
	if req.PathParameter("workspace") != "" {
		conditions.Match[openpitrix2.WorkspaceLabel] = req.PathParameter("workspace")
	}
...
func (h *openpitrixHandler) DoAppAction(req *restful.Request, resp *restful.Response) {
	var doActionRequest openpitrix2.ActionRequest
	...
	appId := strings.TrimSuffix(req.PathParameter("app"), v1alpha12.HelmApplicationAppStoreSuffix)
...
func (h *openpitrixHandler) CreateApp(req *restful.Request, resp *restful.Response) {
	createAppRequest := &openpitrix2.CreateAppRequest{}
	...
	if validate {
		validatePackageRequest := &openpitrix2.ValidatePackageRequest{
...
func (h *openpitrixHandler) ModifyApp(req *restful.Request, resp *restful.Response) {
	var patchAppRequest openpitrix2.ModifyAppRequest
...
func (h *openpitrixHandler) CreateAppVersion(req *restful.Request, resp *restful.Response) {
	var createAppVersionRequest openpitrix2.CreateAppVersionRequest
...
func (h *openpitrixHandler) ListAppVersions(req *restful.Request, resp *restful.Response) {
	...
	reverse := params.GetBoolValueWithDefault(req, params.ReverseParam, false)
	appId := req.PathParameter("app")
	appId = strings.TrimSuffix(appId, v1alpha12.HelmApplicationAppStoreSuffix)
	...
	conditions.Match[openpitrix2.AppId] = appId

	if req.PathParameter("workspace") != "" {
		conditions.Match[openpitrix2.WorkspaceLabel] = req.PathParameter("workspace")
	}

	if conditions.Match[openpitrix2.WorkspaceLabel] == "" {
		conditions.Match[openpitrix2.WorkspaceLabel] = req.QueryParameter("workspace")
	}
...
func (h *openpitrixHandler) ModifyAppVersion(req *restful.Request, resp *restful.Response) {
	...
	var patchAppVersionRequest openpitrix2.ModifyAppVersionRequest
...
func (h *openpitrixHandler) GetAppVersionFiles(req *restful.Request, resp *restful.Response) {
	versionId := req.PathParameter("version")
	getAppVersionFilesRequest := &openpitrix2.GetAppVersionFilesRequest{}
...
func (h *openpitrixHandler) ListAppVersionAudits(req *restful.Request, resp *restful.Response) {
	limit, offset := params.ParsePaging(req)
	orderBy := params.GetStringValueWithDefault(req, params.OrderByParam, openpitrix2.StatusTime)
	reverse := params.GetBoolValueWithDefault(req, params.ReverseParam, false)
	appId := req.PathParameter("app")
	versionId := req.PathParameter("version")
	conditions, err := params.ParseConditions(req)
	...
	conditions.Match[openpitrix2.AppId] = strings.TrimSuffix(appId, v1alpha12.HelmApplicationAppStoreSuffix)
	if versionId != "" {
		conditions.Match[openpitrix2.VersionId] = versionId
	}
...
func (h *openpitrixHandler) ListApplications(req *restful.Request, resp *restful.Response) {
	...
	reverse := false
	if conditions.Match[openpitrix2.Ascending] == "true" {
		reverse = true
	}
...
func (h *openpitrixHandler) UpgradeApplication(req *restful.Request, resp *restful.Response) {
	namespace := req.PathParameter("namespace")
	applicationId := req.PathParameter("application")
	var upgradeClusterRequest openpitrix2.UpgradeClusterRequest
...
func (h *openpitrixHandler) ModifyApplication(req *restful.Request, resp *restful.Response) {
	var modifyClusterAttributesRequest openpitrix2.ModifyClusterAttributesRequest
	applicationId := req.PathParameter("application")
	namespace := req.PathParameter("namespace")
...
func (h *openpitrixHandler) CreateApplication(req *restful.Request, resp *restful.Response) {
	...
	namespace := req.PathParameter("namespace")
	workspace := req.PathParameter("workspace")
	var createClusterRequest openpitrix2.CreateClusterRequest
...
func (h *openpitrixHandler) CreateCategory(req *restful.Request, resp *restful.Response) {
	createCategoryRequest := &openpitrix2.CreateCategoryRequest{}
...
func (h *openpitrixHandler) ModifyCategory(req *restful.Request, resp *restful.Response) {
	var modifyCategoryRequest openpitrix2.ModifyCategoryRequest
	categoryId := req.PathParameter("category")
...
func (h *openpitrixHandler) CreateAttachment(req *restful.Request, resp *restful.Response) {
	...
	var att *openpitrix2.Attachment
