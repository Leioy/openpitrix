...
func (c *categoryOperator) getCategoryByName(name string) (*v1alpha12.HelmCategory, error) {
...
func (c *categoryOperator) createCategory(name, desc string) (*v1alpha12.HelmCategory, error) {
