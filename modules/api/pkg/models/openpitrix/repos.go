...
type RepoInterface interface {
	CreateRepo(repo *v1alpha13.HelmRepo) (*CreateRepoResponse, error)
	DeleteRepo(id string) error
	ValidateRepo(u string, request *v1alpha13.HelmRepoCredential) (*ValidateRepoResponse, error)
...
func (c *repoOperator) ValidateRepo(u string, cred *v1alpha13.HelmRepoCredential) (*ValidateRepoResponse, error) {
...
func (c *repoOperator) CreateRepo(repo *v1alpha13.HelmRepo) (*CreateRepoResponse, error) {
...
func (c *repoOperator) ModifyRepo(id string, request *ModifyRepoRequest) error {
	...
	if request.SyncPeriod != nil {
		...
		if syncPeriod == 0 {
			...
			delete(repoCopy.Annotations, v1alpha13.RepoSyncPeriod)
		} else {
			repoCopy.Spec.SyncPeriod = syncPeriod
			repoCopy.Annotations[v1alpha13.RepoSyncPeriod] = *request.SyncPeriod
		}
	}
	...
	if request.URL != nil && len(*request.URL) > 0 {
		...
		parsedUrl.User = nil
		cred := &v1alpha13.HelmRepoCredential{}
...
func helmRepoFilter(namePrefix string, list []*v1alpha13.HelmRepo) (res []*v1alpha13.HelmRepo) {
...
type HelmRepoList []*v1alpha13.HelmRepo
