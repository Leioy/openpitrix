...
import (
	...
	resources "kubesphere.io/openpitrix/pkg/models/resources/v1alpha3"
	"kubesphere.io/openpitrix/pkg/models/resources/v1alpha3/openpitrix/application"
	"kubesphere.io/openpitrix/pkg/models/resources/v1alpha3/openpitrix/applicationversion"
)

type ApplicationInterface interface {
	DescribeAppVersion(id string) (*v1alpha12.HelmApplicationVersion, error)
	DescribeApp(id string) (*v1alpha12.HelmApplication, error)
...
func (c *applicationOperator) DescribeApp(verId string) (*v1alpha12.HelmApplication, error) {
	...
	return ret.(*v1alpha12.HelmApplication), nil
}
