...
import (
	...
	"kubesphere.io/openpitrix/pkg/client/openpitrix/helmrepoindex"
	...
	"kubesphere.io/openpitrix/pkg/utils/sliceutil"
...
func convertRepoEvent(meta *metav1.ObjectMeta, state *v1alpha12.HelmRepoSyncState) *RepoEvent {
...
func convertAppVersionAudit(appVersion *v1alpha12.HelmApplicationVersion) []*AppVersionAudit {
	if appVersion == nil {
		return nil
	}
...
type HelmReleaseList []*v1alpha12.HelmRelease
...
func convertCategory(in *v1alpha12.HelmCategory) *Category {
	if in == nil {
		return nil
	}
	out := &Category{}
...
func convertApplication(rls *v1alpha12.HelmRelease, rlsInfos []*resource.Info) *Application {
	app := &Application{}
	...
	if cluster.Status == "" {
		cluster.Status = v1alpha12.HelmStatusCreating
	}
...
func convertApp(app *v1alpha12.HelmApplication, versions []*v1alpha12.HelmApplicationVersion, ctg *v1alpha12.HelmCategory, rlsCount int) *App {
	if app == nil {
		return nil
	}
	out := &App{}
	...
	if out.Status == "" {
		out.Status = v1alpha12.StateDraft
	}
...
func filterAppVersionByState(versions []*v1alpha12.HelmApplicationVersion, states []string) []*v1alpha12.HelmApplicationVersion {
	if len(states) == 0 {
		return versions
	}
...
func convertAppVersion(in *v1alpha12.HelmApplicationVersion) *AppVersion {
	if in == nil {
		return nil
	}
	out := AppVersion{}
...
func convertRepo(in *v1alpha12.HelmRepo) *Repo {
	if in == nil {
		return nil
	}
	out := Repo{}
	...
	out.SyncPeriod = in.Annotations[v1alpha12.RepoSyncPeriod]

	out.URL = in.Spec.Url
	return &out
}

type HelmCategoryList []*v1alpha12.HelmCategory
...
type HelmApplicationList []*v1alpha12.HelmApplication
...
type AppVersionReviews []*v1alpha12.HelmApplicationVersion
...
type AppVersions []*v1alpha12.HelmApplicationVersion
...
func buildApplicationVersion(app *v1alpha12.HelmApplication, chrt helmrepoindex.VersionInterface, chartPackage *string, creator string) *v1alpha12.HelmApplicationVersion {
	// create helm application version resource
	t := metav1.Now()
	ver := &v1alpha12.HelmApplicationVersion{
		...
		Spec: v1alpha12.HelmApplicationVersionSpec{
			Metadata: &v1alpha12.Metadata{
				...
				Icon:        chrt.GetIcon(),
				Home:        chrt.GetHome(),
				Description: stringutils.ShortenString(chrt.GetDescription(), v1alpha12.MsgLen),
		...
		Status: v1alpha12.HelmApplicationVersionStatus{
			State: v1alpha12.StateDraft,
			Audit: []v1alpha12.Audit{
				{
					State:    v1alpha12.StateDraft,
					Time:     t,
					Operator: creator,
...
func filterAppByName(app *v1alpha12.HelmApplication, namePart string) bool {
	if len(namePart) == 0 {
		return true
	}
...
func filterAppByStates(app *v1alpha12.HelmApplication, state []string) bool {
	if len(state) == 0 {
		return true
	}
	st := app.Status.State
...
func filterAppReviews(versions []*v1alpha12.HelmApplicationVersion, conditions *params.Conditions) []*v1alpha12.HelmApplicationVersion {
...
func filterAppVersions(versions []*v1alpha12.HelmApplicationVersion, conditions *params.Conditions) []*v1alpha12.HelmApplicationVersion {
	if conditions == nil || len(conditions.Match) == 0 || len(versions) == 0 {
		return versions
	}
...
func filterApps(apps []*v1alpha12.HelmApplication, conditions *params.Conditions) []*v1alpha12.HelmApplication {
...
func filterReleaseByStates(rls *v1alpha12.HelmRelease, state []string) bool {
	if len(state) == 0 {
		return true
	}
	st := rls.Status.State
	if st == "" {
		st = v1alpha12.HelmStatusCreating
	}
	if sliceutil.HasString(state, st) {
		return true
	}
...
func filterReleasesWithAppVersions(releases []*v1alpha12.HelmRelease, appVersions map[string]*v1alpha12.HelmApplicationVersion) []*v1alpha12.HelmRelease {
	if appVersions == nil || len(appVersions) == 0 || len(releases) == 0 {
		return []*v1alpha12.HelmRelease{}
	}
...
func filterReleases(releases []*v1alpha12.HelmRelease, conditions *params.Conditions) []*v1alpha12.HelmRelease {
...
func convertAppVersionReview(app *v1alpha12.HelmApplication, appVersion *v1alpha12.HelmApplicationVersion) *AppVersionReview {
