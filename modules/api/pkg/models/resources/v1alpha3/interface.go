...
type Interface interface {
	...
	List(namespace string, query *query2.Query) (*api.ListResult, error)
}

// CompareFunc return true is left great than right
type CompareFunc func(runtime.Object, runtime.Object, query2.Field) bool

type FilterFunc func(runtime.Object, query2.Filter) bool

type TransformFunc func(runtime.Object) runtime.Object

func DefaultList(objects []runtime.Object, q *query2.Query, compareFunc CompareFunc, filterFunc FilterFunc, transformFuncs ...TransformFunc) *api.ListResult {
	// selected matched ones
	var filtered []runtime.Object
	for _, object := range objects {
		selected := true
		for field, value := range q.Filters {
			if !filterFunc(object, query2.Filter{Field: field, Value: value}) {
				selected = false
				break
			}
		}
	...
	if q.Pagination == nil {
		q.Pagination = query2.NoPagination
	}
...
func DefaultObjectMetaCompare(left, right metav1.ObjectMeta, sortBy query2.Field) bool {
	switch sortBy {
	// ?sortBy=name
	...
	default:
		fallthrough
	case query2.FieldCreateTime:
		fallthrough
	case query2.FieldCreationTimeStamp:
...
func DefaultObjectMetaFilter(item metav1.ObjectMeta, filter query2.Filter) bool {
	switch filter.Field {
	case query2.FieldNames:
	...
	case query2.FieldOwnerReference:
