...
func (r *helmCategoriesGetter) List(_ string, query *query2.Query) (*api.ListResult, error) {
...
func (r *helmCategoriesGetter) compare(left runtime.Object, right runtime.Object, field query2.Field) bool {
...
func (r *helmCategoriesGetter) filter(object runtime.Object, filter query2.Filter) bool {
