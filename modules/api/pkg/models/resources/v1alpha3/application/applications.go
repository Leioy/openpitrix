...
func (d *applicationsGetter) List(namespace string, query *query2.Query) (*api.ListResult, error) {
...
func (d *applicationsGetter) compare(left runtime.Object, right runtime.Object, field query2.Field) bool {
	...
	switch field {
	case query2.FieldUpdateTime:
		fallthrough
	case query2.FieldLastUpdateTimestamp:
...
func (d *applicationsGetter) filter(object runtime.Object, filter query2.Filter) bool {
