...
func NewAPIServerCommand() (cmd *cobra.Command) {
	...
	// Load configuration from file /etc/openpitrix/openpitrix.yaml
	...
	cmd = &cobra.Command{
		Use: "OpenPitrix API Server",
		Long: `The OpenPitrix API server validates and configures data for the API objects. 
